...
- **Station G3** — BQESP32V1M + BQ35LORA900V1M, Station G2-compatible radio/display pins, persistent Station G3-only web/API selection of lower or higher PA PL1 mode on GPIO9 (lower by default), GPIO10 external LNA enabled for RX and bypassed for TX, optional GROVE GPS on IO7/IO15, and max SX1262 drive capped at 19 dBm. Remove the PA PL1/LNA P jumpers for software GPIO control; PA PL2 remains a physical jumper.
