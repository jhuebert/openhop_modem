...
// Battery sense (P0.04, A0). Not used by openHop Modem yet but kept
...
// openHop Modem uses these for the host-facing UART when the board
...
// Adafruit BSP's Adafruit_LittleFS init even if openHop Modem never writes
// to it.
