/*
  RAK4631 USB-only openHop Modem variant.
  Pin identities are based on RAKWireless/RAK-nRF52-Arduino's
  WisCore_RAK4631_Board variant. The global WisBlock SPI definitions remain
  available, while the internal SX1262 uses NRF_SPIM2 from main.cpp.
*/
#ifndef _VARIANT_RAK4631_OPENHOP_USB_
#define _VARIANT_RAK4631_OPENHOP_USB_
